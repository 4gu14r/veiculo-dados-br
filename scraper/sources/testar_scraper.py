...
def testar_fluxo_unico():
    ...
    with ScraperCobaia(delay=1.0) as scraper:
        ...
        print(f"✓ Sucesso! Primeiro modelo encontrado: {primeiro_modelo['nome']} ({primeiro_modelo['url']})")
        ...
        print(f"✓ Sucesso! Primeira versão encontrada: {primeira_versao['versao']} | Ano: {primeira_versao['ano']}")
